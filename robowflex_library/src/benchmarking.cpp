...
///
/// SearchPlanDataSetOutputter
///

SearchPlanDataSetOutputter::SearchPlanDataSetOutputter(const std::string &prefix) : prefix_(prefix)
{
}

SearchPlanDataSetOutputter::~SearchPlanDataSetOutputter()
{
}
